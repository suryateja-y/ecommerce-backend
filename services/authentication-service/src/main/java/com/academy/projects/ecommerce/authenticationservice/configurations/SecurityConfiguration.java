...
import com.academy.projects.ecommerce.authenticationservice.services.authentication.Authenticate;
...
public class SecurityConfiguration {
    ...
    @Autowired
    public SecurityConfiguration(AuthenticationProvider authenticationProvider, Authenticate authenticate, AuthenticationEntryPoint authenticationEntryPoint, AccessDenierErrorHandler accessDenierErrorHandler) {
    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        http
                ...
                .authorizeHttpRequests(request -> request
                        .requestMatchers("/api/" + version + "/authentication/login", "api/" + version + "/authentication/isValid").permitAll()
